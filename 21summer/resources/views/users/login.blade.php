                ...
                <div class="container px-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            <li class="nav-item"><a class="nav-link" href="{{URL::to('/index')}}">Trở về Home</a></li>
                ...
                <div class="container px-5">
                    ...
                    <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                        <div class="text-center mb-5">
                            ...
                            <p class="lead fw-normal text-muted mb-0"> Nếu bạn đã đăng ký, vui lòng đăng nhập !</p>
                        </div>
                        <div class="row gx-5 justify-content-center">
                            ...
                            ?>
                                ...
                                <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="{{URL::to('/dangnhap_user')}}" method="post">
                                    {{ csrf_field() }}
                        ...
                        <div class="d-grid">
                            <button class="btn btn-danger btn-lg" id="submitButton" name="dang_ky" type="submit">Đăng nhập</button>
                        </div>
